SELECT a.region, nb.primaryname, tb.startyear, tb.genres, c.directors, MIN(r.averagerating), MAX(r.averagerating), AVG(r.averagerating)
FROM principals p
...
GROUP BY a.region, nb.primaryname, tb.startyear, tb.genres, c.directors;