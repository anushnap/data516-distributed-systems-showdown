SELECT YEAR(l.l_shipdate), r.r_name, n.n_name, s.s_name, AVG(l.l_extendedprice) AS avg_cost, MIN(l.l_extendedprice) AS min_cost, 
...
GROUP BY YEAR(l.l_shipdate), r.r_name, n.n_name, s.s_name;